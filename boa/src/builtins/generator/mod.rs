...
impl Generator {
    ...
    pub(crate) fn r#return(
        ...
        Generator::generator_resume_abrupt(this, Ok(args.get_or_undefined(0).clone()), context)
    }
    ...
    pub(crate) fn throw(
        ...
        // 3. Return ? GeneratorResumeAbrupt(g, C, empty).
        Generator::generator_resume_abrupt(this, Err(args.get_or_undefined(0).clone()), context)
    }
    ...
    pub(crate) fn generator_resume(
        ...
        std::mem::swap(&mut context.realm, &mut generator_context.realm);
