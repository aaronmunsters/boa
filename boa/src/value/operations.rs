...
impl JsValue {
    ...
    pub fn add(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            // Fast path:
            (JsVariant::Integer(x), JsVariant::Integer(y)) => Self::new(f64::from(x) + f64::from(y)),
            ...
            (JsVariant::String(ref x), JsVariant::String(ref y)) => Self::from(JsString::concat(x, y)),
            (JsVariant::String(ref x), _) => Self::new(JsString::concat(x, other.to_string(context)?)),
            (_, JsVariant::String(ref y)) => Self::new(JsString::concat(self.to_string(context)?, y)),
    ...
    pub fn rem(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::Rational(x), JsVariant::Integer(y)) => Self::new((x % f64::from(y)).copysign(x)),
            (JsVariant::BigInt(ref x), JsVariant::BigInt(ref y)) => {
                if y.is_zero() {
                    return context.throw_range_error("BigInt division by zero");
                }
    ...
    pub fn pow(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::BigInt(ref a), JsVariant::BigInt(ref b)) => Self::new(JsBigInt::pow(a, b, context)?),
    ...
    pub fn bitand(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::BigInt(ref x), JsVariant::BigInt(ref y)) => Self::new(JsBigInt::bitand(x, y)),
    ...
    pub fn bitor(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::BigInt(ref x), JsVariant::BigInt(ref y)) => Self::new(JsBigInt::bitor(x, y)),
    ...
    pub fn bitxor(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::BigInt(ref x), JsVariant::BigInt(ref y)) => Self::new(JsBigInt::bitxor(x, y)),
    ...
    pub fn shl(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::Integer(x), JsVariant::Rational(y)) => Self::new(x.wrapping_shl(f64_to_uint32(y))),
    ...
    pub fn shr(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::Integer(x), JsVariant::Rational(y)) => Self::new(x.wrapping_shr(f64_to_uint32(y))),
            (JsVariant::Rational(x), JsVariant::Integer(y)) => {
    ...
    pub fn ushr(&self, other: &Self, context: &mut Context) -> JsResult<Self> {
        Ok(match (self.variant(), other.variant()) {
            // Fast path:
            (JsVariant::Integer(x), JsVariant::Integer(y)) => Self::new((x as u32).wrapping_shr(y as u32)),
            (JsVariant::Rational(x), JsVariant::Rational(y)) => {
