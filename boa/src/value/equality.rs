use super::{JsBigInt, JsObject, JsResult, JsValue, PreferredType, JsVariant};
...
impl JsValue {
    ...
    pub fn equals(&self, other: &Self, context: &mut Context) -> JsResult<bool> {
        ...
        Ok(match (self.variant(), other.variant()) {
            ...
            (JsVariant::Null, JsVariant::Undefined) | (JsVariant::Undefined, JsVariant::Null) => true,
            ...
            (JsVariant::Integer(_) | JsVariant::Rational(_), JsVariant::String(_) | JsVariant::Boolean(_))
            ...
            (JsVariant::BigInt(ref a), JsVariant::String(ref b)) => match JsBigInt::from_string(b) {
                Some(ref b) => a == b,
                None => false,
            },

            // 7. If Type(x) is String and Type(y) is BigInt, return the result of the comparison y == x.
            (JsVariant::String(ref a), JsVariant::BigInt(ref b)) => match JsBigInt::from_string(a) {
                Some(ref a) => a == b,
                None => false,
            },

            // 8. If Type(x) is Boolean, return the result of the comparison ! ToNumber(x) == y.
            (JsVariant::Boolean(x), _) => return other.equals(&Self::new(x as i32), context),

            // 9. If Type(y) is Boolean, return the result of the comparison x == ! ToNumber(y).
            (_, JsVariant::Boolean(y)) => return self.equals(&Self::new(y as i32), context),
